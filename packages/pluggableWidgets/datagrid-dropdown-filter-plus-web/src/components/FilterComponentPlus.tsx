...
export interface FilterOptionPlus {
    caption: string;
    value: string;
}
...
export function FilterComponentPlus(props: FilterComponentPlusProps): ReactElement {
    ...
    const [options, setOptions] = useState<FilterOptionPlus[]>([]);
    const [selectedFilters, setSelectedFilters] = useState<FilterOptionPlus[]>([]);
    ...
    const setMultiSelectFilters = useCallback(
        (selectedOptions: FilterOptionPlus[]) => {
            ...
            if (props.multiSelect) {
                if (props.defaultValue) {
                    const initialOptions = props.defaultValue
                        ...
                        .filter(Boolean) as FilterOptionPlus[];
...
function toggleFilter(filters: FilterOptionPlus[], filterToToggle: FilterOptionPlus): FilterOptionPlus[] {
