...
describe("Filter selector", () => {
    describe("with single selection", () => {
        describe("renders correctly", () => {
            it("with options", () => {
                const component = render(<FilterComponentPlus options={defaultOptions} />);

                expect(component).toMatchSnapshot();
            });
            it("with no options", () => {
                const component = render(<FilterComponentPlus options={[]} />);

                expect(component).toMatchSnapshot();
            });
            it("with ariaLabel", () => {
                const component = render(<FilterComponentPlus options={defaultOptions} ariaLabel="my label" />);

                expect(component).toMatchSnapshot();
            });
            it("with emptyOptioncaption", () => {
                const component = render(
                    <FilterComponentPlus options={defaultOptions} emptyOptionCaption={"find me"} />
                );
        ...
        it("selects default option", () => {
            ...
            const component = shallow(
                <FilterComponentPlus options={defaultOptions} defaultValue={defaultOption.value} />
            );
        ...
        describe("when value changes", () => {
            it("calls updateFilters when value changes", () => {
                ...
                const component = shallow(
                    <FilterComponentPlus options={defaultOptions} updateFilters={updateFilterHandler} />
                );
    ...
    describe("with multi selection", () => {
        describe("renders correctly", () => {
            it("with options", () => {
                const component = render(<FilterComponentPlus multiSelect options={defaultOptions} />);

                expect(component).toMatchSnapshot();
            });
            it("with no options", () => {
                const component = render(<FilterComponentPlus multiSelect options={[]} />);

                expect(component).toMatchSnapshot();
            });
            it("with ariaLabel", () => {
                const component = render(
                    <FilterComponentPlus options={defaultOptions} multiSelect ariaLabel="my label" />
                );
            ...
            it("with emptyOptioncaption", () => {
                const component = render(
                    <FilterComponentPlus multiSelect options={defaultOptions} emptyOptionCaption={"find me"} />
                );
        ...
        describe("with default options set", () => {
            it("selects single default option", () => {
                const defaultOption = defaultOptions[0];
                const component = shallow(
                    <FilterComponentPlus multiSelect options={defaultOptions} defaultValue={defaultOption.value} />
                );
            ...
            it("selects multiple default options", () => {
                ...
                const component = shallow(
                    <FilterComponentPlus multiSelect options={defaultOptions} defaultValue={defaultValue} />
                );
            ...
            it("filters incorrect default options", () => {
                ...
                const component = shallow(
                    <FilterComponentPlus multiSelect options={defaultOptions} defaultValue={inCorrectDefaultValue} />
                );
        ...
        describe("when value changes", () => {
            it("calls updateFilters when value changes", () => {
                ...
                const component = mount(
                    <FilterComponentPlus multiSelect options={defaultOptions} updateFilters={updateFiltersHandler} />
                );
            ...
            it("shows selected options on input value", () => {
                const onClickProps = { preventDefault: jest.fn(), stopPropagation: jest.fn() };
                const component = mount(<FilterComponentPlus multiSelect options={defaultOptions} />);
    ...
    describe("focus", () => {
        ...
        it("changes focused element when pressing the input", () => {
            renderTestingLib(<FilterComponentPlus options={defaultOptions} emptyOptionCaption="Click me" />);
        ...
        it("changes focused element back to the input when pressing tab on the last item", () => {
            renderTestingLib(
                <FilterComponentPlus options={[{ caption: "1", value: "_1" }]} emptyOptionCaption="Click me" />
            );
