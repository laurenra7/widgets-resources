...
import { ColumnsType, DatagridPlusContainerProps } from "../typings/DatagridPlusProps";
...
export default function DatagridPlus(props: DatagridPlusContainerProps): ReactElement {
    const id = useRef(`DataGridPlus${generateUUID()}`);
