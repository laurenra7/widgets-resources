...
import { ColumnsPreviewType, DatagridPlusPreviewProps } from "../typings/DatagridPlusProps";

export function getProperties(
    values: DatagridPlusPreviewProps,
...
export const getPreview = (values: DatagridPlusPreviewProps, isDarkMode: boolean): StructurePreviewProps => {
...
export function check(values: DatagridPlusPreviewProps): Problem[] {
