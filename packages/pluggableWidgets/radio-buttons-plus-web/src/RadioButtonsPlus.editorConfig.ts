...
import { RadioButtonsPlusPreviewProps } from "../typings/RadioButtonsPlusProps";
...
export function getPreview(values: RadioButtonsPlusPreviewProps, isDark: boolean): StructurePreviewProps {
...
export function getProperties(values: RadioButtonsPlusPreviewProps, defaultProperties: Properties): Properties {
    if (!values.showLabel) {
