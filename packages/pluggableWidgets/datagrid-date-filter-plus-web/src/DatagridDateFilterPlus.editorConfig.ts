...
import { DatagridDateFilterPlusPreviewProps, DefaultFilterEnum } from "../typings/DatagridDateFilterPlusProps";

export function getProperties(
    values: DatagridDateFilterPlusPreviewProps,
...
export const getPreview = (values: DatagridDateFilterPlusPreviewProps, isDarkMode: boolean): StructurePreviewProps => {
